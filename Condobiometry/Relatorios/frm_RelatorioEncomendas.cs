...
{
    public partial class frm_RelatorioEncomendas : Form
    {
        ...
        public frm_RelatorioEncomendas()
        {
            InitializeComponent();
        }

        private void frm_RelatorioEncomendas_Load(object sender, EventArgs e)
        {
            ...
            this.reportViewer1.LocalReport.DataSources.Add(new Microsoft.Reporting.WinForms.ReportDataSource("DataSet2", DataTable_Report));

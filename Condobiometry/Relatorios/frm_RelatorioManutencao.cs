...
{
    public partial class frm_RelatorioManutencao : Form
    {
        ...
        public frm_RelatorioManutencao()
        {
            InitializeComponent();
        }

        private void frm_RelatorioManutencao_Load(object sender, EventArgs e)
        {
            ...
            this.reportViewer1.LocalReport.DataSources.Add(new Microsoft.Reporting.WinForms.ReportDataSource("DataSet4", DataTable_Report));
